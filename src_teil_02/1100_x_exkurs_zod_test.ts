...
// Typen testen
// 1. mit expect-type Bibliothek (integriert in vitest)
//   - https://www.npmjs.com/package/expect-type
//   - https://vitest.dev/api/expect-typeof
expectTypeOf(Person).toEqualTypeOf<IPerson>;

// mit "type-testing" (https://github.com/MichiganTypeScript/type-testing/):
type X = Expect<Equal<IPerson, TPerson>>;
